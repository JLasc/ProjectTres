...
const OrderComplete = props => {
  ...
  return (
    <div>
      ...
      <div className="finishContainer"><div><p className="finish">Total:</p></div><div><p className="right margin-right-20">${(Number(props.orderTotal) + Number(props.shipping)).toFixed(2)}</p></div></div>
